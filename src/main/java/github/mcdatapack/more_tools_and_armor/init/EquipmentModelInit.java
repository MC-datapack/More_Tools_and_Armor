...
public class EquipmentModelInit implements EquipmentAssetKeys {
    ...
    public static final RegistryKey<EquipmentAsset> ANCIENT = register("ancient");

    public static RegistryKey<EquipmentAsset> register(String name) {
        return RegistryKey.of(EquipmentAssetKeys.REGISTRY_KEY, MoreToolsAndArmor.id(name));
    }
}
