...
public class ItemGroupInit {
    ...
    public static final ItemGroup MORE_TOOLS_AND_ARMOR_GROUP = register("more_tools_and_armor_group", FabricItemGroup.builder()
            ...
            .entries((displayContext, entries) -> {
                ...
                entries.add(WAXED_COPPER_INGOT);
                entries.add(EXPOSED_COPPER_INGOT);
                entries.add(WAXED_EXPOSED_COPPER_INGOT);
                entries.add(WEATHERED_COPPER_INGOT);
                entries.add(WAXED_WEATHERED_COPPER_INGOT);
                entries.add(OXIDIZED_COPPER_INGOT);
                entries.add(WAXED_OXIDIZED_COPPER_INGOT);
                ...
                entries.add(EXPOSED_COPPER_PAXEL);
                entries.add(WEATHERED_COPPER_PAXEL);
                entries.add(OXIDIZED_COPPER_PAXEL);
                ...
                entries.add(EXPOSED_COPPER_HAMMER);
                entries.add(WEATHERED_COPPER_HAMMER);
                entries.add(OXIDIZED_COPPER_HAMMER);
