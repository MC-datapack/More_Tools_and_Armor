...
public class BlockInit {
    public static final HoneyBlock ANCIENT_HONEY_BLOCK = registerWithItem("ancient_honey_block", settings -> new HoneyBlock(
            settings.mapColor(MapColor.ORANGE).velocityMultiplier(0.4F).jumpVelocityMultiplier(0.5F).nonOpaque().sounds(BlockSoundGroup.HONEY)));
    ...
    public static final Block DEEPSLATE_EMERALD_BLOCK = registerWithItemDefault("deepslate_emerald_block", new Block(AbstractBlock.Settings.create()
    ...
    public static final Block END_DIAMOND_BLOCK = registerWithItemDefault("end_diamond_block", new Block(AbstractBlock.Settings.create()
    ...
    public static final Block SCULK_EMERALD_BLOCK = registerWithItemDefault("sculk_emerald_block", new Block(AbstractBlock.Settings.create()
    ...
    public static final Block BLACKSTONE_EMERALD_BLOCK = registerWithItemDefault("blackstone_emerald_block", new Block(AbstractBlock.Settings.create()
    ...
    public static final Block END_EMERALD_BLOCK = registerWithItemDefault("end_emerald_block", new Block(AbstractBlock.Settings.create()
    ...
    public static final Block END_COAL_ORE = registerWithItemDefault("end_coal_ore",
    ...
    public static final Block END_COPPER_ORE = registerWithItemDefault("end_copper_ore", new Block(copy(Blocks.DEEPSLATE_COPPER_ORE)
    ...
    public static final Block END_IRON_ORE = registerWithItemDefault("end_iron_ore", new Block(copy(Blocks.DEEPSLATE_IRON_ORE)
    ...
    public static final Block END_GOLD_ORE = registerWithItemDefault("end_gold_ore", new Block(copy(Blocks.DEEPSLATE_GOLD_ORE)
    ...
    public static final Block END_LAPIS_LAZULI_ORE = registerWithItemDefault("end_lapis_lazuli_ore",
    ...
    public static final Block END_EMERALD_ORE = registerWithItemDefault("end_emerald_ore",
    ...
    public static final Block END_REDSTONE_ORE = registerWithItemDefault("end_redstone_ore",
    ...
    public static final Block END_DIAMOND_ORE = registerWithItemDefault("end_diamond_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5, 10),
    ...
    public static final Block SCULK_EMERALD_ORE = registerWithItemDefault("sculk_emerald_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5, 10),
    ...
    public static final Block BLACKSTONE_EMERALD_ORE = registerWithItemDefault("blackstone_emerald_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(5, 10),
    ...
    public static <T extends Block> T registerDefault(String name, T block) {
    ...
    public static  <T extends Block> T registerWithItemDefault(String name, T block, Item.Settings settings) {
        T registered = registerDefault(name, block);
        ItemInit.registerDefault(name, new BlockItem(registered, settings));
        return registered;
    }
