...
public class ConvertPickaxeItem extends MoreToolsAndArmorPickaxeItem {
    private final int max;

    public ConvertPickaxeItem(int max, ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
