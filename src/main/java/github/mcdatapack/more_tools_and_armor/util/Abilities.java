...
public class Abilities {
    ...
    private static ItemStack[] getArmorItems(LivingEntity entity) {
        return new ItemStack[]{entity.getEquippedStack(EquipmentSlot.HEAD), entity.getEquippedStack(EquipmentSlot.CHEST),
                entity.getEquippedStack(EquipmentSlot.LEGS), entity.getEquippedStack(EquipmentSlot.FEET)};
    }
}