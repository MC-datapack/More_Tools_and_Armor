...
import github.mcdatapack.more_tools_and_armor.datagen.generator.MoreToolsAndArmorRegistryGenerator;
...
public class MoreToolsAndArmorDataGenerator implements DataGeneratorEntrypoint {
	...
	public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
		...
		pack.addProvider(MoreToolsAndArmorRegistryGenerator::new);
	...
	public void buildRegistry(RegistrySetBuilder registryBuilder) {
		registryBuilder.add(Registries.FEATURE, ConfiguredFeatureInit::bootstrap);
		...
		registryBuilder.add(Registries.BLOCK_TRANSFORMER, BlockTransformerInit::bootstrap);
	}
}
