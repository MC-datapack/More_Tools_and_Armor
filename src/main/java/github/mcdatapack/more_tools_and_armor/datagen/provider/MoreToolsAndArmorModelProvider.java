...
public class MoreToolsAndArmorModelProvider extends FabricModelProvider {
    public static final Identifier HELMET = getTrimAssetIdPrefix("helmet");
    public static final Identifier CHESTPLATE = getTrimAssetIdPrefix("chestplate");
    public static final Identifier LEGGINGS = getTrimAssetIdPrefix("leggings");
    public static final Identifier BOOTS = getTrimAssetIdPrefix("boots");
