    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider provider, BootstrapContext<Recipe<?>> bootstrapContext, BootstrapContext<Advancement> bootstrapContext1) {
        return new RecipeProvider(bootstrapContext, bootstrapContext1) {
            ...
            public void buildRecipes() {
                ...
                upgradeRecipe(Items.DIAMOND, OVERWORLD_SHARD, Items.EMERALD, DEEPSLATE_EMERALD,itemLookup, output);
                upgradeRecipe(Items.DIAMOND, OVERWORLD_SHARD, Items.SCULK, SCULK_EMERALD,itemLookup, output);
                upgradeRecipe(Items.DIAMOND, NETHER_SHARD, Items.EMERALD, BLACKSTONE_EMERALD,itemLookup, output);
                upgradeRecipe(Items.DIAMOND, END_SHARD, Items.EMERALD, END_EMERALD,itemLookup, output);
                upgradeRecipe(Items.DIAMOND, END_SHARD, Items.DIAMOND, END_DIAMOND,itemLookup, output);
                ...
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ANCIENT_UPGRADE_SMITHING_TEMPLATE)
                        ...
                        .save(output, "ancient_upgrade_smithing_template");
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ANCIENT_UPGRADE_SMITHING_TEMPLATE, 2)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(ANCIENT_INGOT), has(ANCIENT_INGOT))
                        .save(output, "ancient_upgrade_smithing_template_dupe");
                ...
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ItemInit.DEEPSLATE_EMERALD_UPGRADE_SMITHING_TEMPLATE, 2)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(DEEPSLATE_EMERALD), has(DEEPSLATE_EMERALD))
                        .save(output, "deepslate_emerald_upgrade_smithing_template");
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, DEEPSLATE_EMERALD_UPGRADE_SMITHING_TEMPLATE, 2)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(DEEPSLATE_EMERALD), has(DEEPSLATE_EMERALD))
                        .save(output, "deepslate_emerald_upgrade_smithing_template_dupe");
                ...
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, END_DIAMOND_UPGRADE_SMITHING_TEMPLATE)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(END_DIAMOND), has(END_DIAMOND))
                        .save(output, "end_diamond_upgrade_smithing_template");
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, END_DIAMOND_UPGRADE_SMITHING_TEMPLATE, 2)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(END_DIAMOND), has(END_DIAMOND))
                        .save(output, "end_diamond_upgrade_smithing_template_dupe");
                ...
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, VOID_UPGRADE_SMITHING_TEMPLATE)
                        ...
                        .save(output, "void_upgrade_smithing_template");
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, VOID_UPGRADE_SMITHING_TEMPLATE, 2)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(VOID_INGOT), has(VOID_INGOT))
                        .save(output, "void_upgrade_smithing_template_dupe");
                ...
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ONETHDENDERITE_UPGRADE_SMITHING_TEMPLATE)
                        ...
                        .save(output, "onethdenderite_upgrade_smithing_template");
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ONETHDENDERITE_UPGRADE_SMITHING_TEMPLATE, 2)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(ONETHDENDERITE_INGOT), has(ONETHDENDERITE_INGOT))
                        .save(output, "onethdenderite_upgrade_smithing_template_dupe");
                ...
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, OLED_UPGRADE_SMITHING_TEMPLATE)
                        ...
                        .save(output, "oled_upgrade_smithing_template");
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, OLED_UPGRADE_SMITHING_TEMPLATE, 2)
                        ...
                        .pattern("AAA")
                        .unlockedBy(getItemName(OLED_INGOT), has(OLED_INGOT))
                        .save(output, "oled_upgrade_smithing_template_dupe");


                craftFromResourceRecipes(Items.COAL,
                        COAL_SWORD, COAL_AXE, COAL_PICKAXE, COAL_SHOVEL, COAL_HOE, COAL_HELMET, COAL_CHESTPLATE, COAL_LEGGINGS, COAL_BOOTS, COAL_PAXEL, COAL_HAMMER, COAL_SPEAR, itemLookup, output);
                craftFromResourceRecipes(Items.LAPIS_LAZULI, LAPIS_SWORD, LAPIS_AXE, LAPIS_PICKAXE, LAPIS_SHOVEL, LAPIS_HOE,
                        LAPIS_HELMET, LAPIS_CHESTPLATE, LAPIS_LEGGINGS, LAPIS_BOOTS, LAPIS_PAXEL, LAPIS_HAMMER, LAPIS_SPEAR,itemLookup, output);
                craftFromResourceRecipes(BUDDING_AMETHYST_CRYSTAL, BUDDING_AMETHYST_SWORD, BUDDING_AMETHYST_AXE, BUDDING_AMETHYST_PICKAXE, BUDDING_AMETHYST_SHOVEL, BUDDING_AMETHYST_HOE,
                        BUDDING_AMETHYST_HELMET, BUDDING_AMETHYST_CHESTPLATE, BUDDING_AMETHYST_LEGGINGS, BUDDING_AMETHYST_BOOTS, BUDDING_AMETHYST_PAXEL, BUDDING_AMETHYST_HAMMER, BUDDING_AMETHYST_SPEAR,itemLookup, output);
                craftFromResourceRecipes(Items.EMERALD, EMERALD_SWORD, EMERALD_AXE, EMERALD_PICKAXE, EMERALD_SHOVEL, EMERALD_HOE,
                        EMERALD_HELMET, EMERALD_CHESTPLATE, EMERALD_LEGGINGS, EMERALD_BOOTS, EMERALD_PAXEL, EMERALD_HAMMER, EMERALD_SPEAR,itemLookup, output);
                craftFromResourceRecipes(Items.REDSTONE, REDSTONE_SWORD, REDSTONE_AXE, REDSTONE_PICKAXE, REDSTONE_SHOVEL, REDSTONE_HOE,
                        REDSTONE_HELMET, REDSTONE_CHESTPLATE, REDSTONE_LEGGINGS, REDSTONE_BOOTS, REDSTONE_PAXEL, REDSTONE_HAMMER, REDSTONE_SPEAR,itemLookup, output);
                craftFromResourceRecipes(Items.OBSIDIAN, OBSIDIAN_SWORD, OBSIDIAN_AXE, OBSIDIAN_PICKAXE, OBSIDIAN_SHOVEL, OBSIDIAN_HOE,
                        OBSIDIAN_HELMET, OBSIDIAN_CHESTPLATE, OBSIDIAN_LEGGINGS, OBSIDIAN_BOOTS, OBSIDIAN_PAXEL, OBSIDIAN_HAMMER, OBSIDIAN_SPEAR,itemLookup, output);
                ...
                upgradeRecipes(DEEPSLATE_EMERALD_UPGRADE_SMITHING_TEMPLATE,
                        ...
                        DEEPSLATE_EMERALD,itemLookup, output);
                ...
                upgradeRecipes(ONETHDENDERITE_UPGRADE_SMITHING_TEMPLATE,
                        ...
                        ONETHDENDERITE_INGOT,itemLookup, output);
                ...
                upgradeRecipes(ANCIENT_UPGRADE_SMITHING_TEMPLATE,
                        ...
                        ANCIENT_INGOT,itemLookup, output);



                paxelAndHammer(ItemTags.PLANKS, Items.WOODEN_PICKAXE, Items.WOODEN_AXE, Items.WOODEN_SHOVEL, Items.WOODEN_HOE, WOODEN_PAXEL, WOODEN_HAMMER,itemLookup, output);
                paxelAndHammer(Items.COBBLESTONE, Items.STONE_PICKAXE, Items.STONE_AXE, Items.STONE_SHOVEL, Items.STONE_HOE, STONE_PAXEL, STONE_HAMMER,itemLookup, output);
                paxelAndHammer(Items.GOLD_INGOT, Items.GOLDEN_PICKAXE, Items.GOLDEN_AXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_HOE, GOLDEN_PAXEL, GOLDEN_HAMMER,itemLookup, output);
                paxelAndHammer(Items.IRON_INGOT, Items.IRON_PICKAXE, Items.IRON_AXE, Items.IRON_SHOVEL, Items.IRON_HOE, IRON_PAXEL, IRON_HAMMER,itemLookup, output);
                paxelAndHammer(Items.DIAMOND, Items.DIAMOND_PICKAXE, Items.DIAMOND_AXE, Items.DIAMOND_SHOVEL, Items.DIAMOND_HOE, DIAMOND_PAXEL, DIAMOND_HAMMER,itemLookup, output);
                paxelAndHammer(Items.COPPER_INGOT, Items.COPPER_PICKAXE, Items.COPPER_AXE, Items.COPPER_SHOVEL, Items.COPPER_HOE, COPPER_PAXEL, COPPER_HAMMER,itemLookup, output);


                upgradeRecipe(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE, DIAMOND_PAXEL, Items.NETHERITE_INGOT, NETHERITE_PAXEL,itemLookup, output);
                upgradeRecipe(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE, DIAMOND_HAMMER, Items.NETHERITE_INGOT, NETHERITE_HAMMER,itemLookup, output);
            }
            ...
            private void craftFromResourceRecipes(Item resource,
                                                  ...
                                                  Item paxel, Item hammer, Item spear, HolderGetter<Item> itemLookup, RecipeOutput output) {
            ...
            private void paxelAndHammer(TagKey<Item> resource, Item axe, Item pickaxe, Item shovel, Item hoe, Item paxel, Item hammer, HolderGetter<Item> itemLookup, RecipeOutput output) {
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.TOOLS, hammer)
                        .define('A', resource)
                        .define('B', WOODEN_RODS)
                        .pattern("AAA")
            ...
            private void paxelAndHammer(Item resource, Item axe, Item pickaxe, Item shovel, Item hoe, Item paxel, Item hammer, HolderGetter<Item> itemLookup, RecipeOutput output) {
                ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.TOOLS, hammer)
                        .define('A', resource)
                        .define('B', WOODEN_RODS)
                        .pattern("AAA")
            ...
            private void upgradeRecipes(Item template,
                                        ...
                                        Item addition, HolderGetter<Item> itemLookup, RecipeOutput output)  {
                upgradeRecipe(template, baseHelmet, addition, helmet, itemLookup, output);
                upgradeRecipe(template, baseChestplate, addition, chestplate, itemLookup, output);
                upgradeRecipe(template, baseLeggings, addition, leggings, itemLookup, output);
                upgradeRecipe(template, baseBoots, addition, boots, itemLookup, output);
                upgradeRecipe(template, baseSword, addition, sword, itemLookup, output);
                upgradeRecipe(template, baseAxe, addition, axe, itemLookup, output);
                upgradeRecipe(template, basePickaxe, addition, pickaxe, itemLookup, output);
                upgradeRecipe(template, baseShovel, addition, shovel, itemLookup, output);
                upgradeRecipe(template, baseHoe, addition, hoe, itemLookup, output);
                upgradeRecipe(template, basePaxel, addition, paxel, itemLookup, output);
                upgradeRecipe(template, baseHammer, addition, hammer, itemLookup, output);
                upgradeRecipe(template, baseSpear, addition, spear, itemLookup, output);
                ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.TOOLS, paxel)
                        .requires(axe).requires(pickaxe).requires(shovel).requires(hoe)
                        .unlockedBy(getItemName(pickaxe), has(pickaxe))
                        .save(output);
            ...
            private void upgradeRecipe(Item template, Item base, Item addition, Item result, HolderGetter<Item> getter, RecipeOutput output) {
                SmithingTransformRecipeBuilder.smithing( Ingredient.of(template), Ingredient.of(base), Ingredient.of(addition),
                        ...
                        .save(output, ResourceKey.create(Registries.RECIPE, MoreToolsAndArmor.id(getItemName(result) + "_upgrade")));
            }
        };
    }
