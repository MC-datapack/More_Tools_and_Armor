...
public class MoreToolsAndArmorRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        upgradeRecipe(AIR, OVERWORLD_SHARD, EMERALD, DEEPSLATE_EMERALD, exporter);
        upgradeRecipe(AIR, OVERWORLD_SHARD, SCULK, SCULK_EMERALD, exporter);
        upgradeRecipe(AIR, NETHER_SHARD, EMERALD, BLACKSTONE_EMERALD, exporter);
        upgradeRecipe(AIR, END_SHARD, EMERALD, END_EMERALD, exporter);
        upgradeRecipe(AIR, END_SHARD, DIAMOND, END_DIAMOND, exporter);
        ...
        craftFromResourceRecipes(Items.COAL,
                COAL_SWORD, COAL_AXE, COAL_PICKAXE, COAL_SHOVEL, COAL_HOE, COAL_HELMET, COAL_CHESTPLATE, COAL_LEGGINGS, COAL_BOOTS, COAL_PAXEL, COAL_HAMMER, exporter);
        craftFromResourceRecipes(COPPER_INGOT, COPPER_SWORD, COPPER_AXE, COPPER_PICKAXE, COPPER_SHOVEL, COPPER_HOE,
                COPPER_HELMET, COPPER_CHESTPLATE, COPPER_LEGGINGS, COPPER_BOOTS, COPPER_PAXEL, COPPER_HAMMER, exporter);
        craftFromResourceRecipes(LAPIS_LAZULI, LAPIS_SWORD, LAPIS_AXE, LAPIS_PICKAXE, LAPIS_SHOVEL, LAPIS_HOE,
                LAPIS_HELMET, LAPIS_CHESTPLATE, LAPIS_LEGGINGS, LAPIS_BOOTS, LAPIS_PAXEL, LAPIS_HAMMER, exporter);
        craftFromResourceRecipes(BUDDING_AMETHYST_CRYSTAL, BUDDING_AMETHYST_SWORD, BUDDING_AMETHYST_AXE, BUDDING_AMETHYST_PICKAXE, BUDDING_AMETHYST_SHOVEL, BUDDING_AMETHYST_HOE,
                BUDDING_AMETHYST_HELMET, BUDDING_AMETHYST_CHESTPLATE, BUDDING_AMETHYST_LEGGINGS, BUDDING_AMETHYST_BOOTS, BUDDING_AMETHYST_PAXEL, BUDDING_AMETHYST_HAMMER, exporter);
        craftFromResourceRecipes(EMERALD, EMERALD_SWORD, EMERALD_AXE, EMERALD_PICKAXE, EMERALD_SHOVEL, EMERALD_HOE,
                EMERALD_HELMET, EMERALD_CHESTPLATE, EMERALD_LEGGINGS, EMERALD_BOOTS, EMERALD_PAXEL, EMERALD_HAMMER, exporter);
        craftFromResourceRecipes(REDSTONE, REDSTONE_SWORD, REDSTONE_AXE, REDSTONE_PICKAXE, REDSTONE_SHOVEL, REDSTONE_HOE,
                REDSTONE_HELMET, REDSTONE_CHESTPLATE, REDSTONE_LEGGINGS, REDSTONE_BOOTS, REDSTONE_PAXEL, REDSTONE_HAMMER, exporter);
        craftFromResourceRecipes(OBSIDIAN, OBSIDIAN_SWORD, OBSIDIAN_AXE, OBSIDIAN_PICKAXE, OBSIDIAN_SHOVEL, OBSIDIAN_HOE,
                OBSIDIAN_HELMET, OBSIDIAN_CHESTPLATE, OBSIDIAN_LEGGINGS, OBSIDIAN_BOOTS, OBSIDIAN_PAXEL, OBSIDIAN_HAMMER, exporter);
        ...
        paxelAndHammer(ItemTags.PLANKS, WOODEN_PICKAXE, WOODEN_AXE, WOODEN_SHOVEL, WOODEN_HOE, WOODEN_PAXEL, WOODEN_HAMMER, exporter);
        paxelAndHammer(COBBLESTONE, STONE_PICKAXE, STONE_AXE, STONE_SHOVEL, STONE_HOE, STONE_PAXEL, STONE_HAMMER, exporter);
        paxelAndHammer(GOLD_INGOT, GOLDEN_PICKAXE, GOLDEN_AXE, GOLDEN_SHOVEL, GOLDEN_HOE, GOLDEN_PAXEL, GOLDEN_HAMMER, exporter);
        paxelAndHammer(IRON_INGOT, IRON_PICKAXE, IRON_AXE, IRON_SHOVEL, IRON_HOE, IRON_PAXEL, IRON_HAMMER, exporter);
        paxelAndHammer(DIAMOND, DIAMOND_PICKAXE, DIAMOND_AXE, DIAMOND_SHOVEL, DIAMOND_HOE, DIAMOND_PAXEL, DIAMOND_HAMMER, exporter);


        upgradeRecipe(NETHERITE_UPGRADE_SMITHING_TEMPLATE, DIAMOND_PAXEL, NETHERITE_INGOT, NETHERITE_PAXEL, exporter);
        upgradeRecipe(NETHERITE_UPGRADE_SMITHING_TEMPLATE, DIAMOND_HAMMER, NETHERITE_INGOT, NETHERITE_HAMMER, exporter);
    }
    ...
    private void craftFromResourceRecipes(Item resource,
                                          ...
                                          Item paxel, Item hammer, RecipeExporter exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, hammer)
                ...
                .criterion(hasItem(resource), conditionsFromItem(resource))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, helmet)
                .input('A', resource)
                .pattern("AAA")
                .pattern("A A")
                .criterion(hasItem(resource), conditionsFromItem(resource))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, chestplate)
                .input('A', resource)
                .pattern("A A")
                .pattern("AAA")
                .pattern("AAA")
                .criterion(hasItem(resource), conditionsFromItem(resource))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, leggings)
                .input('A', resource)
                .pattern("AAA")
                .pattern("A A")
                .pattern("A A")
                .criterion(hasItem(resource), conditionsFromItem(resource))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, boots)
                .input('A', resource)
                .pattern("A A")
                .pattern("A A")
                .criterion(hasItem(resource), conditionsFromItem(resource))
                .offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.TOOLS, paxel)
                .input(axe).input(pickaxe).input(shovel).input(hoe)
                .criterion(hasItem(pickaxe), conditionsFromItem(pickaxe))
                .offerTo(exporter);
    }

    private void paxelAndHammer(TagKey<Item> resource, Item axe, Item pickaxe, Item shovel, Item hoe, Item paxel, Item hammer, RecipeExporter exporter) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, hammer)
                .input('A', resource)
                .input('B', WOODEN_RODS)
                .pattern("AAA")
    ...
    private void paxelAndHammer(Item resource, Item axe, Item pickaxe, Item shovel, Item hoe, Item paxel, Item hammer, RecipeExporter exporter) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, hammer)
                .input('A', resource)
                .input('B', WOODEN_RODS)
                .pattern("AAA")
    ...
    private void upgradeRecipes(Item template,
                                ...
                                Item addition, RecipeExporter exporter)  {
        ...
        upgradeRecipe(template, baseHammer, addition, hammer, exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.TOOLS, paxel)
                .input(axe).input(pickaxe).input(shovel).input(hoe)
                .criterion(hasItem(pickaxe), conditionsFromItem(pickaxe))
                .offerTo(exporter);
