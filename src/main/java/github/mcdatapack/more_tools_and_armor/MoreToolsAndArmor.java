...
public class MoreToolsAndArmor implements ModInitializer {
	...
	public void onInitialize() {
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(entries -> entries.addAfter(Items.DIAMOND, ItemInit.END_DIAMOND));
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(entries -> entries.addAfter(ItemInit.DEEPSLATE_EMERALD,ItemInit.END_EMERALD));
